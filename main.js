...
async function petArea() {
  const petsPromise = await fetch("https://melodious-swan-41bbd3.netlify.app/.netlify/functions/pets")
...
allButtons.forEach(element => {
  element.addEventListener("click", handelButtoClick)
})
function handelButtoClick(event) {
